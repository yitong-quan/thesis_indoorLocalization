...
>>
refine the 'XXX - Copy.log' file by 'data_format_refine_HTerm.m', and get 'XXX - Copy_refined.log'
>>
generate matrix formate data of time and distance by 'read_file_gene_matr__with_timeStmp.m', and save it with self defined name, i.e. 'xxx.mat'.
>>
import 'xxx.mat' and run 'KF_using_HTerm_data.m'


Note that the postions of the nodes should be supplied to the 'KF_using_HTerm_data.m',
