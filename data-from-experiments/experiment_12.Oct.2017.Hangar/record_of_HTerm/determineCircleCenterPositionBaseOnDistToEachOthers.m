...
plot(P(1,:), P(2,:), '-*');
daspect([10,10,10]);
% cal the optimal dist2eachOther
dist2eachOther = zeros(5,1);
for i = 1:size(nodePositions,2)
        dist2eachOther(i) =  norm(nodePositions(:,i) - P) ;
end
...
%%with the radium of the pillar: +6cm, leads to Residual of 0.00875655
%%without the radium of the pillar: 6cm, leads to Residual of 0.00180581
true_dist2eachOther = [4.20, 5.90, 4.93, 4.58, 5.33]'; %without the radium of the pillar
