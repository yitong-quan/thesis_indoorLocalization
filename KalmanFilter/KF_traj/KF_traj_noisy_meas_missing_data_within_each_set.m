...
%           numOfMeasMissingWithinEachSet: int , rangs from 0 to numNodes
%           traj_num: string : '01'
%}
%%
function [X, P] = KF_traj_noisy_meas_missing_data_within_each_set(factor_Q, factor_R, measurements_missing, numOfMeasMissingWithinEachSet, traj_name)
